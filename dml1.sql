...
-- 컴퓨터 상태
insert into COMPUTER_STATUS values (COMPUTER_STATUS_SEQ.nextval, '정상');
insert into COMPUTER_STATUS values (COMPUTER_STATUS_SEQ.nextval, '고장');
insert into COMPUTER_STATUS values (COMPUTER_STATUS_SEQ.nextval, '수리중');
insert into COMPUTER_STATUS values (COMPUTER_STATUS_SEQ.nextval, '수리예정');
